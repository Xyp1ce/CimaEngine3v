...
\hypertarget{imgui__impl__dx12_8h_source}{}\label{imgui__impl__dx12_8h_source}\index{build/\_deps/imgui-\/src/backends/imgui\_impl\_dx12.h@{build/\_deps/imgui-\/src/backends/imgui\_impl\_dx12.h}}
...
\DoxyCodeLine{00028\ \textcolor{keyword}{struct\ }ImGui\_ImplDX12\_InitInfo}
\DoxyCodeLine{00029\ \{}
...
\DoxyCodeLine{00040\ \ \ \ \ void\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ (*SrvDescriptorAllocFn)(ImGui\_ImplDX12\_InitInfo*\ info,\ D3D12\_CPU\_DESCRIPTOR\_HANDLE*\ out\_cpu\_desc\_handle,\ D3D12\_GPU\_DESCRIPTOR\_HANDLE*\ out\_gpu\_desc\_handle);}
\DoxyCodeLine{00041\ \ \ \ \ void\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ (*SrvDescriptorFreeFn)(ImGui\_ImplDX12\_InitInfo*\ info,\ D3D12\_CPU\_DESCRIPTOR\_HANDLE\ cpu\_desc\_handle,\ D3D12\_GPU\_DESCRIPTOR\_HANDLE\ gpu\_desc\_handle);}
...
\DoxyCodeLine{00046\ }
\DoxyCodeLine{00047\ \ \ \ \ ImGui\_ImplDX12\_InitInfo()\ \ \ \{\ memset((\textcolor{keywordtype}{void}*)\textcolor{keyword}{this},\ 0,\ \textcolor{keyword}{sizeof}(*\textcolor{keyword}{this}));\ \}}
\DoxyCodeLine{00048\ \};}
\DoxyCodeLine{00049\ }
\DoxyCodeLine{00050\ \textcolor{comment}{//\ Follow\ "{}Getting\ Started"{}\ link\ and\ check\ examples/\ folder\ to\ learn\ about\ using\ backends!}}
\DoxyCodeLine{00051\ IMGUI\_IMPL\_API\ \textcolor{keywordtype}{bool}\ \ \ \ \ ImGui\_ImplDX12\_Init(\doxymbox{\hyperlink{struct_im_gui___impl_d_x12___init_info}{ImGui\_ImplDX12\_InitInfo}}*\ info);}
...
\DoxyCodeLine{00054\ IMGUI\_IMPL\_API\ \textcolor{keywordtype}{void}\ \ \ \ \ ImGui\_ImplDX12\_RenderDrawData(\doxymbox{\hyperlink{struct_im_draw_data}{ImDrawData}}*\ draw\_data,\ ID3D12GraphicsCommandList*\ graphics\_command\_list);}
\DoxyCodeLine{00055\ }
...
\DoxyCodeLine{00070\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{struct_im_gui___impl_d_x12___render_state}{ImGui\_ImplDX12\_RenderState}}}
\DoxyCodeLine{00071\ \{}
