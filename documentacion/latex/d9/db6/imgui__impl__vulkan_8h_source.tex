...
\DoxyCodeLine{00077\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{struct_im_gui___impl_vulkan___init_info}{ImGui\_ImplVulkan\_InitInfo}}}
\DoxyCodeLine{00078\ \{}
...
\DoxyCodeLine{00112\ IMGUI\_IMPL\_API\ \textcolor{keywordtype}{bool}\ \ \ \ \ \ \ \ \ \ \ \ \ ImGui\_ImplVulkan\_Init(\doxymbox{\hyperlink{struct_im_gui___impl_vulkan___init_info}{ImGui\_ImplVulkan\_InitInfo}}*\ info);}
...
\DoxyCodeLine{00115\ IMGUI\_IMPL\_API\ \textcolor{keywordtype}{void}\ \ \ \ \ \ \ \ \ \ \ \ \ ImGui\_ImplVulkan\_RenderDrawData(\doxymbox{\hyperlink{struct_im_draw_data}{ImDrawData}}*\ draw\_data,\ VkCommandBuffer\ command\_buffer,\ VkPipeline\ pipeline\ =\ VK\_NULL\_HANDLE);}
...
\DoxyCodeLine{00133\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{struct_im_gui___impl_vulkan___render_state}{ImGui\_ImplVulkan\_RenderState}}}
\DoxyCodeLine{00134\ \{}
...
\DoxyCodeLine{00161\ }
\DoxyCodeLine{00162\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{struct_im_gui___impl_vulkan_h___frame}{ImGui\_ImplVulkanH\_Frame}};}
\DoxyCodeLine{00163\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{struct_im_gui___impl_vulkan_h___window}{ImGui\_ImplVulkanH\_Window}};}
\DoxyCodeLine{00164\ }
...
\DoxyCodeLine{00167\ IMGUI\_IMPL\_API\ \textcolor{keywordtype}{void}\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ImGui\_ImplVulkanH\_DestroyWindow(VkInstance\ instance,\ VkDevice\ device,\ \doxymbox{\hyperlink{struct_im_gui___impl_vulkan_h___window}{ImGui\_ImplVulkanH\_Window}}*\ wd,\ \textcolor{keyword}{const}\ VkAllocationCallbacks*\ allocator);}
...
\DoxyCodeLine{00177\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{struct_im_gui___impl_vulkan_h___frame}{ImGui\_ImplVulkanH\_Frame}}}
\DoxyCodeLine{00178\ \{}
...
\DoxyCodeLine{00185\ \};}
\DoxyCodeLine{00186\ }
\DoxyCodeLine{00187\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{struct_im_gui___impl_vulkan_h___frame_semaphores}{ImGui\_ImplVulkanH\_FrameSemaphores}}}
\DoxyCodeLine{00188\ \{}
...
\DoxyCodeLine{00195\ \textcolor{keyword}{struct\ }ImGui\_ImplVulkanH\_Window}
\DoxyCodeLine{00196\ \{}
...
\DoxyCodeLine{00211\ \ \ \ \ \doxymbox{\hyperlink{struct_im_vector}{ImVector<ImGui\_ImplVulkanH\_Frame>}}\ \ \ \ \ \ \ \ \ \ \ Frames;}
\DoxyCodeLine{00212\ \ \ \ \ \doxymbox{\hyperlink{struct_im_vector}{ImVector<ImGui\_ImplVulkanH\_FrameSemaphores>}}\ FrameSemaphores;}
\DoxyCodeLine{00213\ }
\DoxyCodeLine{00214\ \ \ \ \ ImGui\_ImplVulkanH\_Window()}
\DoxyCodeLine{00215\ \ \ \ \ \{}
