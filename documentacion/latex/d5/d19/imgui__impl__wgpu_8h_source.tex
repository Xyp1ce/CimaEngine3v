...
\hypertarget{imgui__impl__wgpu_8h_source}{}\label{imgui__impl__wgpu_8h_source}\index{build/\_deps/imgui-\/src/backends/imgui\_impl\_wgpu.h@{build/\_deps/imgui-\/src/backends/imgui\_impl\_wgpu.h}}
...
\DoxyCodeLine{00034\ \textcolor{keyword}{struct\ }ImGui\_ImplWGPU\_InitInfo}
\DoxyCodeLine{00035\ \{}
...
\DoxyCodeLine{00041\ }
\DoxyCodeLine{00042\ \ \ \ \ ImGui\_ImplWGPU\_InitInfo()}
\DoxyCodeLine{00043\ \ \ \ \ \{}
...
\DoxyCodeLine{00051\ IMGUI\_IMPL\_API\ \textcolor{keywordtype}{bool}\ ImGui\_ImplWGPU\_Init(\doxymbox{\hyperlink{struct_im_gui___impl_w_g_p_u___init_info}{ImGui\_ImplWGPU\_InitInfo}}*\ init\_info);}
...
\DoxyCodeLine{00054\ IMGUI\_IMPL\_API\ \textcolor{keywordtype}{void}\ ImGui\_ImplWGPU\_RenderDrawData(\doxymbox{\hyperlink{struct_im_draw_data}{ImDrawData}}*\ draw\_data,\ WGPURenderPassEncoder\ pass\_encoder);}
\DoxyCodeLine{00055\ }
...
\DoxyCodeLine{00063\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{struct_im_gui___impl_w_g_p_u___render_state}{ImGui\_ImplWGPU\_RenderState}}}
\DoxyCodeLine{00064\ \{}
