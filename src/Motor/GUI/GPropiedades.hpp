...
/**
 * @class GPropiedades
 * @brief Inspector de propiedades para editar objetos y tilemaps en tiempo
 * real.
 *
...
public:
  ...
  ~GPropiedades() override { delete guipath; };
...
private:
  ...
  /**
   * @brief Renderiza panel de Maquina de Estado.
   * @param path Puntero al componente IMaquinaEstado a mostrar
